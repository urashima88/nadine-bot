...
def set_cart_session(user_id: int, cart_text_message_id: int, cart_message_id: int):
    user_cart_edit_sessions[user_id] = {
        ...
        "cart_text_message_id": cart_text_message_id,
        "cart_message_id": cart_message_id,
        "cart_control_edit_message_ids": []
    }
    
def add_control_edit_message_id(user_id: int, control_edit_message_id: int):
    if user_id in user_cart_edit_sessions:
        user_cart_edit_sessions[user_id]["cart_control_edit_message_ids"].append(control_edit_message_id)
        return True
    return False
